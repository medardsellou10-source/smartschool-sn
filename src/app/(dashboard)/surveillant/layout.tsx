  ...
  return (
    <>
      <div style={{
        ...
        >
          <source src="/Vidéo/bg-dashboard-surveillant.mp4" type="video/mp4" />
        </video>

        {/* Overlay cinématique or surveillant */}
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(160deg, rgba(2,6,23,0.93) 0%, rgba(25,20,0,0.88) 40%, rgba(2,6,23,0.93) 100%)',
        }} />
