...
const Icons = {
  ...
  robot: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="11" width="18" height="10" rx="2" strokeLinecap="round" strokeLinejoin="round"/><circle cx="12" cy="5" r="2"/><path d="M12 7v4M8 15h.01M16 15h.01" strokeLinecap="round"/><path d="M7 11V9a5 5 0 0110 0v2" strokeLinecap="round"/></svg>,
}
...
const MENUS: Record<string, NavItem[]> = {
  admin_global: [
    ...
    { href: '/admin/finances/dashboard', label: 'Dashboard Finance', icon: Icons.trending },
  ...
  intendant: [
    ...
    { href: '/intendant/paiements',        label: 'Paiements parents', icon: Icons.money },
    { href: '/intendant/salaires',         label: 'Salaires personnel',icon: Icons.payment },
    { href: '/intendant/achats',           label: 'Achats fournisseurs',icon: Icons.card },
    { href: '/intendant/comptabilite',     label: 'Comptabilité (SYSCOA)', icon: Icons.book },
    { href: '/intendant/bourses',          label: 'Bourses & exonérations', icon: Icons.award },
    { href: '/intendant/fiscalite',        label: 'Fiscalité (TVA / Patente)', icon: Icons.shield },
  ...
  censeur: [
    ...
    { href: '/censeur/conseils-classe', label: 'Conseils de classe', icon: Icons.users },
