...
export const RESSOURCES_EN_LIGNE: RessourceEnLigne[] = [
  ...
  // ── Cours Vidéo ──
  { id: 'res-101', titre: 'Les suites numériques — Cours complet', type: 'video', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S1', description: 'Cours vidéo sur les suites arithmétiques, géométriques et récurrentes avec exemples détaillés', source: 'Sunudaara / Ecoles au Sénégal', url: 'https://sunudaara.com/bac-senegal-math' },
  { id: 'res-102', titre: 'Intégration — De A à Z', type: 'video', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S1', description: 'Primitives, intégrales, techniques de calcul — cours vidéo complet', source: 'Sunudaara / Mbacké Maths', url: 'https://www.mbackemaths.com/category/cours/terminale-s1-cours/maths-terminale-s1-cours/' },
  { id: 'res-103', titre: 'Les nombres complexes', type: 'video', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S1', description: 'Forme algébrique, trigonométrique, exponentielle — cours filmé', source: 'Mbacké Maths', url: 'https://www.mbackemaths.com/category/cours/terminale-s1-cours/maths-terminale-s1-cours/' },
  { id: 'res-104', titre: 'Mécanique — Lois de Newton', type: 'video', matiere: 'Sciences Physiques', niveau: 'Terminale', serie: 'S1', description: 'PFD, théorèmes de l\'énergie, projectiles — cours complet', source: 'Sunudaara PC', url: 'https://sunudaara.com/bac-senegal-pc' },
  { id: 'res-105', titre: 'Circuits RLC — Oscillations', type: 'video', matiere: 'Sciences Physiques', niveau: 'Terminale', serie: 'S1', description: 'Condensateur, bobine, circuits RLC libre et forcé', source: 'Sunudaara PC', url: 'https://sunudaara.com/bac-senegal-pc' },
  { id: 'res-106', titre: 'Chimie organique — Nomenclature et réactions', type: 'video', matiere: 'Sciences Physiques', niveau: 'Terminale', serie: 'S1', description: 'Cours vidéo sur la chimie organique niveau BAC', source: 'Physique-Chimie SN (Wahab Diop)', url: 'https://physiquechimie.godaddysites.com/bac' },
  { id: 'res-107', titre: 'Génétique — Brassage et hérédité', type: 'video', matiere: 'SVT', niveau: 'Terminale', serie: 'S1', description: 'Méiose, crossing-over, génétique humaine', source: 'Sunudaara SVT', url: 'https://www.sunudaara.com/cours-svt-terminale' },
  { id: 'res-108', titre: 'Immunologie — Le système immunitaire', type: 'video', matiere: 'SVT', niveau: 'Terminale', serie: 'S1', description: 'Immunité innée et adaptative — cours filmé', source: 'Sunudaara SVT', url: 'https://www.sunudaara.com/cours-svt-terminale' },
  { id: 'res-109', titre: 'La conscience et l\'inconscient — Philo', type: 'video', matiere: 'Philosophie', niveau: 'Terminale', serie: 'L', description: 'Descartes, Freud, Sartre — cours de philosophie filmé', source: 'SenRévision Philosophie', url: 'https://senrevision.com/cour/philosophie-tle/' },
  { id: 'res-110', titre: 'Méthodologie dissertation Philo', type: 'video', matiere: 'Philosophie', niveau: 'Terminale', serie: 'L', description: 'Comment rédiger une dissertation de philo — méthode complète', source: 'Sunudaara Philo', url: 'https://sunudaara.com/bac-senegal-philo' },
  ...
  { id: 'res-111', titre: 'Philosophie — La liberté (Terminale L)', type: 'video', matiere: 'Philosophie', niveau: 'Terminale', serie: 'L', description: 'Déterminisme, libre arbitre, responsabilité — cours filmé avec exemples et textes philosophiques', source: 'SenRévision Philosophie', url: 'https://senrevision.com/cour/philosophie-tle/' },
  { id: 'res-112', titre: 'Philosophie — La société et l\'État', type: 'video', matiere: 'Philosophie', niveau: 'Terminale', serie: 'L', description: 'Contrat social, démocratie, justice sociale — cours complet Terminale L', source: 'Sunudaara Philo', url: 'https://sunudaara.com/bac-senegal-philo' },
  { id: 'res-113', titre: 'Philosophie — La connaissance et la vérité', type: 'video', matiere: 'Philosophie', niveau: 'Terminale', serie: 'L', description: 'Rationalisme, empirisme, vérité scientifique — vidéo cours niveau BAC', source: 'Sunudaara Philo', url: 'https://sunudaara.com/bac-senegal-philo' },
  { id: 'res-114', titre: 'Français — Méthode du commentaire composé', type: 'video', matiere: 'Français', niveau: 'Terminale', description: 'Lecture analytique, axes de lecture, rédaction du commentaire — méthode complète filmée', source: 'SenRévision Français', url: 'https://senrevision.com/cour/francais-tle/' },
  { id: 'res-115', titre: 'Français — Analyse de la poésie africaine', type: 'video', matiere: 'Français', niveau: 'Terminale', description: 'Senghor, Césaire, Diop — analyse stylistique et thématique de la poésie négritudienne', source: 'Sunudaara Français', url: 'https://sunudaara.com/mati%C3%A8re/fran%C3%A7ais' },
  { id: 'res-116', titre: 'Français — Le roman africain au BAC', type: 'video', matiere: 'Français', niveau: 'Terminale', description: 'Cheikh Hamidou Kane, Sembène Ousmane — étude des œuvres au programme', source: 'SenRévision Français', url: 'https://senrevision.com/cour/francais-tle/' },
  { id: 'res-117', titre: 'Histoire-Géographie — La décolonisation en Afrique', type: 'video', matiere: 'Histoire-Géographie', niveau: 'Terminale', serie: 'L', description: 'Indépendances africaines, rôle du Sénégal, figures de la décolonisation — cours filmé', source: 'Sunudaara HG', url: 'https://sunudaara.com/bac-senegal-hg' },
  { id: 'res-118', titre: 'Histoire-Géographie — La Guerre Froide', type: 'video', matiere: 'Histoire-Géographie', niveau: 'Terminale', serie: 'L', description: 'Origines, crises, fin de la Guerre Froide et impact sur l\'Afrique', source: 'Sunudaara HG', url: 'https://www.sunudaara.com/histoire-terminale' },
  { id: 'res-119', titre: 'Histoire-Géographie — Géographie de l\'Afrique', type: 'video', matiere: 'Histoire-Géographie', niveau: 'Terminale', serie: 'L', description: 'Milieux naturels, population, économie de l\'Afrique subsaharienne', source: 'Sunudaara HG', url: 'https://sunudaara.com/bac-senegal-hg' },
  { id: 'res-120', titre: 'Mathématiques 3ème — Théorème de Thalès', type: 'video', matiere: 'Mathématiques', niveau: '3ème', description: 'Théorème de Thalès, réciproque et applications — cours filmé niveau BFEM', source: 'Sunudaara 3ème', url: 'https://www.sunudaara.com/cours-svt-3e' },
  ...
  { id: 'v-s1-001', titre: 'Probabilités — Cours complet Terminale S', type: 'video', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S1', description: 'Probabilités conditionnelles, loi binomiale, loi normale — cours complet niveau BAC', source: 'Mbacké Maths / Sunudaara', url: 'https://www.mbackemaths.com/category/cours/terminale-s1-cours/maths-terminale-s1-cours/' },
  { id: 'v-s1-002', titre: 'Équations différentielles — Terminale S1', type: 'video', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S1', description: 'Résolution des équations différentielles du 1er et 2ème ordre — méthodes et exemples', source: 'Mbacké Maths', url: 'https://www.mbackemaths.com/category/series-dexercices/terminale-s1/' },
  { id: 'v-s1-003', titre: 'Géométrie dans l\'espace — Vecteurs 3D', type: 'video', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S1', description: 'Repère orthonormal 3D, équations de plans et droites, distances dans l\'espace', source: 'Mbacké Maths', url: 'https://www.mbackemaths.com/category/cours/terminale-s1-cours/maths-terminale-s1-cours/' },
  { id: 'v-s1-004', titre: 'Optique géométrique — Cours et applications', type: 'video', matiere: 'Sciences Physiques', niveau: 'Terminale', serie: 'S1', description: 'Réflexion, réfraction, lentilles convergentes et divergentes — cours filmé avec TP', source: 'Physique-Chimie SN', url: 'https://physiquechimie.godaddysites.com/td-series-1s' },
  { id: 'v-s1-005', titre: 'Dosages titrages — Chimie Terminale', type: 'video', matiere: 'Sciences Physiques', niveau: 'Terminale', serie: 'S1', description: 'Titrage acido-basique, oxydo-réduction, indicateurs colorés — méthode complète', source: 'Physique-Chimie SN (Wahab Diop)', url: 'https://physiquechimie.godaddysites.com/bac' },
  { id: 'v-s1-006', titre: 'Thermodynamique — Chaleur et énergie', type: 'video', matiere: 'Sciences Physiques', niveau: 'Terminale', serie: 'S1', description: 'Premier et second principe de la thermodynamique, transferts thermiques', source: 'Sunudaara PC', url: 'https://sunudaara.com/bac-senegal-pc' },
  { id: 'v-s1-007', titre: 'Génétique des populations — Hardy-Weinberg', type: 'video', matiere: 'SVT', niveau: 'Terminale', serie: 'S1', description: 'Loi de Hardy-Weinberg, dérive génétique, sélection naturelle', source: 'Sunudaara SVT', url: 'https://www.sunudaara.com/cours-svt-terminale' },
  { id: 'v-s1-008', titre: 'Neurobiologie — Système nerveux', type: 'video', matiere: 'SVT', niveau: 'Terminale', serie: 'S1', description: 'Transmission nerveuse, synapse, arc réflexe — cours filmé avec animations', source: 'Sunudaara SVT', url: 'https://www.sunudaara.com/cours-svt-terminale' },

  // ── Vidéos — Terminale L ──
  { id: 'v-l-001', titre: 'L\'art est-il un luxe ? — Philo Terminale L', type: 'video', matiere: 'Philosophie', niveau: 'Terminale', serie: 'L', description: 'La notion d\'art au programme de philosophie — cours filmé avec textes', source: 'SenRévision / Sunudaara Philo', url: 'https://sunudaara.com/bac-senegal-philo' },
  { id: 'v-l-002', titre: 'Le travail — Notion de philosophie Tle L', type: 'video', matiere: 'Philosophie', niveau: 'Terminale', serie: 'L', description: 'Marx, Hegel, Hannah Arendt — la notion de travail au BAC', source: 'SenRévision Philosophie', url: 'https://senrevision.com/cour/philosophie-tle/' },
  { id: 'v-l-003', titre: 'Littérature africaine — L\'Aventure ambiguë', type: 'video', matiere: 'Français', niveau: 'Terminale', serie: 'L', description: 'Cheikh Hamidou Kane — étude complète de l\'œuvre au programme BAC sénégalais', source: 'SenRévision Français', url: 'https://senrevision.com/cour/francais-tle/' },
  { id: 'v-l-004', titre: 'Le Roman africain — Étude de textes', type: 'video', matiere: 'Français', niveau: 'Terminale', serie: 'L', description: 'Analyse des grands textes de la littérature africaine au programme : Sembène, Senghor', source: 'Sunudaara Français', url: 'https://sunudaara.com/mati%C3%A8re/fran%C3%A7ais' },
  { id: 'v-l-005', titre: 'Décolonisation en Afrique — HG Terminale', type: 'video', matiere: 'Histoire-Géographie', niveau: 'Terminale', serie: 'L', description: 'Les indépendances africaines (1945-1975) — cours complet avec cartes', source: 'Sunudaara HG', url: 'https://sunudaara.com/bac-senegal-hg' },

  // ── Vidéos — Terminale S2 ──
  { id: 'v-s2-001', titre: 'Maths Terminale S2 — Suites numériques', type: 'video', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S2', description: 'Cours de suites numériques Terminale S2 — programme officiel sénégalais', source: 'Mbacké Maths / SunuMaths', url: 'https://www.mbackemaths.com/cours-ll-suites-numeriques-ll-terminale-s2-ll-2026/' },
  { id: 'v-s2-002', titre: 'Maths Terminale S2 — Cours complet', type: 'video', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S2', description: 'Programme complet Maths Terminale S2 — cours, exercices et corrigés', source: 'SunuMaths', url: 'https://sunumaths.com/terminale-s2/' },

  // ── Vidéos — Première ──
  { id: 'v-1-001', titre: 'Probabilités — Première BAC', type: 'video', matiere: 'Mathématiques', niveau: 'Première', description: 'Dénombrement, probabilités, conditionnelles — cours Première', source: 'Jangalma / Ecoles au Sénégal', url: 'https://cours.jangalma.net/programme-classe-de-terminale/' },
  { id: 'v-1-002', titre: 'Dérivation — Cours et exercices Première', type: 'video', matiere: 'Mathématiques', niveau: 'Première', description: 'Dérivées de fonctions composées, tableaux de variation, optimisation', source: 'Sunudaara Maths', url: 'https://sunudaara.com/bac-senegal-math' },
  { id: 'v-1-003', titre: 'Ondes mécaniques — Première S', type: 'video', matiere: 'Sciences Physiques', niveau: 'Première', description: 'Ondes transversales, longitudinales, célérité, périodicité — cours filmé', source: 'Sunudaara PC', url: 'https://sunudaara.com/bac-senegal-pc' },
  { id: 'v-1-004', titre: 'Photosynthèse — SVT Première', type: 'video', matiere: 'SVT', niveau: 'Première', description: 'Mécanismes de la photosynthèse, phases claire et obscure — cours animé', source: 'Sunudaara SVT', url: 'https://www.sunudaara.com/cours-svt-terminale' },

  // ── Vidéos — Seconde ──
  { id: 'v-2-001', titre: 'Algèbre — Calcul littéral Seconde', type: 'video', matiere: 'Mathématiques', niveau: 'Seconde', description: 'Équations du second degré, factorisation, discriminant — base pour les terminales', source: 'Jangalma / Ecoles au Sénégal', url: 'https://www.ecolesausenegal.org/accueil' },
  { id: 'v-2-002', titre: 'Fonctions numériques — Seconde', type: 'video', matiere: 'Mathématiques', niveau: 'Seconde', description: 'Notion de fonction, tableau de variation, représentation graphique', source: 'Jangalma Cours', url: 'https://cours.jangalma.net' },
  { id: 'v-2-003', titre: 'Biologie cellulaire — SVT Seconde', type: 'video', matiere: 'SVT', niveau: 'Seconde', description: 'Structure des cellules eucaryotes et procaryotes, organites cellulaires', source: 'Ecoles au Sénégal', url: 'https://www.ecolesausenegal.org/accueil' },

  // ── Vidéos — 3ème / BFEM ──
  { id: 'v-3e-001', titre: 'Théorème de Pythagore — 3ème complet', type: 'video', matiere: 'Mathématiques', niveau: '3ème', description: 'Théorème de Pythagore et sa réciproque — démonstration et exercices BFEM', source: 'Sunudaara 3ème', url: 'https://www.sunudaara.com/cours-svt-3e' },
  { id: 'v-3e-002', titre: 'Algèbre — Équations et inéquations 3ème', type: 'video', matiere: 'Mathématiques', niveau: '3ème', description: 'Résolution d\'équations du 2nd degré et inéquations — préparation BFEM', source: 'Ecoles au Sénégal', url: 'https://www.ecolesausenegal.org/accueil' },
  { id: 'v-3e-003', titre: 'Statistiques — 3ème et BFEM', type: 'video', matiere: 'Mathématiques', niveau: '3ème', description: 'Moyenne, médiane, mode, diagrammes — cours de statistiques 3ème', source: 'Ecoles au Sénégal', url: 'https://www.ecolesausenegal.org/accueil' },
  { id: 'v-3e-004', titre: 'Grammaire française — 3ème BFEM', type: 'video', matiere: 'Français', niveau: '3ème', description: 'Accord sujet-verbe, propositions, voix active/passive — préparation BFEM', source: 'Jangalma Cours', url: 'https://cours.jangalma.net' },
  { id: 'v-3e-005', titre: 'Forces et mouvement — 3ème Physique', type: 'video', matiere: 'Sciences Physiques', niveau: '3ème', description: 'Forces, poids, réaction normale, équilibre — introduction à la physique', source: 'Ecoles au Sénégal', url: 'https://www.ecolesausenegal.org/accueil' },
  { id: 'v-3e-006', titre: 'Reproduction des êtres vivants — SVT 3ème', type: 'video', matiere: 'SVT', niveau: '3ème', description: 'Reproduction sexuée et asexuée, gamètes, fécondation', source: 'Sunudaara BFEM SVT', url: 'https://www.sunudaara.com/bfem_svt' },

  // ── Vidéos — 4ème ──
  { id: 'v-4e-001', titre: 'Calcul numérique — 4ème Maths', type: 'video', matiere: 'Mathématiques', niveau: '4ème', description: 'Puissances, racines carrées, fractions — cours 4ème', source: 'Ecoles au Sénégal / Jangalma', url: 'https://cours.jangalma.net' },
  { id: 'v-4e-002', titre: 'Électricité — Circuit électrique 4ème', type: 'video', matiere: 'Sciences Physiques', niveau: '4ème', description: 'Circuits en série et en dérivation, loi d\'Ohm, intensité et tension', source: 'Ecoles au Sénégal', url: 'https://www.ecolesausenegal.org/accueil' },

  // ── Vidéos — 5ème ──
  { id: 'v-5e-001', titre: 'Fractions et proportionnalité — 5ème', type: 'video', matiere: 'Mathématiques', niveau: '5ème', description: 'Fractions, proportionnalité, règle de trois — cours 5ème', source: 'Ecoles au Sénégal', url: 'https://www.ecolesausenegal.org/accueil' },
  { id: 'v-5e-002', titre: 'Géographie du Sénégal — 5ème', type: 'video', matiere: 'Histoire-Géographie', niveau: '5ème', description: 'Relief, fleuves, régions naturelles du Sénégal — cours de géographie 5ème', source: 'Jangalma Cours', url: 'https://cours.jangalma.net' },

  // ── Vidéos — 6ème ──
  { id: 'v-6e-001', titre: 'Numération et calculs — 6ème Maths', type: 'video', matiere: 'Mathématiques', niveau: '6ème', description: 'Entiers naturels, opérations, fractions simples — cours de 6ème', source: 'Ecoles au Sénégal', url: 'https://www.ecolesausenegal.org/accueil' },
  { id: 'v-6e-002', titre: 'Géométrie — Figures planes 6ème', type: 'video', matiere: 'Mathématiques', niveau: '6ème', description: 'Triangles, quadrilatères, cercles, périmètres et aires — 6ème', source: 'Ecoles au Sénégal / Jangalma', url: 'https://cours.jangalma.net' },

  // ── Annales supplémentaires avec URLs ──
  { id: 'ann-s1-pc-2023', titre: 'Annales BAC PC S1 — 2023', type: 'annale', matiere: 'Sciences Physiques', niveau: 'Terminale', serie: 'S1', annee: '2023', description: 'Sujet complet Physique-Chimie BAC 2023 S1 — chimie organique, mécanique, électricité', source: 'Office du BAC Sénégal', url: 'https://samabac.sn/sen-annales-bac/' },
  { id: 'ann-s1-svt-2023', titre: 'Annales BAC SVT S1 — 2023', type: 'annale', matiere: 'SVT', niveau: 'Terminale', serie: 'S1', annee: '2023', description: 'Sujet et corrigé SVT BAC 2023 S1 — génétique, immunologie, géologie', source: 'Office du BAC Sénégal', url: 'https://samabac.sn/sen-annales-bac/' },
  { id: 'ann-l-philo-2023', titre: 'Annales BAC Philosophie L — 2023', type: 'annale', matiere: 'Philosophie', niveau: 'Terminale', serie: 'L', annee: '2023', description: 'Sujets de dissertation et commentaire BAC 2023 Philo L — corrigés détaillés', source: 'Office du BAC Sénégal', url: 'https://samabac.sn/sen-annales-bac/' },
  { id: 'ann-l-hg-2023', titre: 'Annales BAC HG L — 2023', type: 'annale', matiere: 'Histoire-Géographie', niveau: 'Terminale', serie: 'L', annee: '2023', description: 'Sujet et corrigé BAC 2023 HG L — histoire du monde, géographie Afrique', source: 'Office du BAC Sénégal', url: 'https://samabac.sn/sen-annales-bac/' },
  { id: 'ann-s2-maths-2023', titre: 'Annales BAC Maths S2 — 2023', type: 'annale', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S2', annee: '2023', description: 'Sujet et corrigé BAC 2023 Maths S2 — statistiques, fonctions, probabilités', source: 'Office du BAC Sénégal', url: 'https://samabac.sn/sen-annales-bac/' },
  { id: 'ann-bfem-pc-2024', titre: 'Annales BFEM PC — 2024', type: 'annale', matiere: 'Sciences Physiques', niveau: '3ème', annee: '2024', description: 'Sujet et corrigé BFEM 2024 Physique-Chimie — électricité, optique, chimie', source: 'MEN Sénégal', url: 'https://samabac.sn/sen-annales-bac/' },
  { id: 'ann-bfem-svt-2024', titre: 'Annales BFEM SVT — 2024', type: 'annale', matiere: 'SVT', niveau: '3ème', annee: '2024', description: 'Sujet et corrigé BFEM 2024 SVT — reproduction, nutrition, écologie', source: 'MEN Sénégal', url: 'https://samabac.sn/sen-annales-bac/' },
  { id: 'ann-bfem-hg-2024', titre: 'Annales BFEM HG — 2024', type: 'annale', matiere: 'Histoire-Géographie', niveau: '3ème', annee: '2024', description: 'Sujet et corrigé BFEM 2024 Histoire-Géographie — histoire Sénégal, Afrique, monde', source: 'MEN Sénégal', url: 'https://samabac.sn/sen-annales-bac/' },
  ...
  // ── COURS NATIFS (contenu intégré dans SmartSchool) ──
  { id: 'nat-maths-tle-s1-suites', titre: 'Cours — Les Suites Numériques', type: 'resume', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S1', description: 'Cours complet natif : suites arithmétiques, géométriques, limites, récurrence — avec exercices corrigés', source: 'SmartSchool SN' },
  { id: 'nat-maths-tle-s1-limites', titre: 'Cours — Limites et Continuité', type: 'resume', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S1', description: 'Cours complet natif : limites de fonctions, formes indéterminées, asymptotes, TVI — avec exercices', source: 'SmartSchool SN' },
  { id: 'nat-maths-tle-s1-integrales', titre: 'Cours — Intégrales et Primitives', type: 'resume', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S1', description: 'Cours complet natif : primitives, intégrale définie, IPP, aires — avec exercices corrigés', source: 'SmartSchool SN' },
  { id: 'nat-maths-tle-s1-complexes', titre: 'Cours — Nombres Complexes', type: 'resume', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S1', description: 'Cours complet natif : forme algébrique, module, argument, exponentielle, équations — avec exercices', source: 'SmartSchool SN' },
  { id: 'nat-maths-tle-s2-stats', titre: 'Cours — Statistiques et Probabilités', type: 'resume', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S2', description: 'Cours complet natif : moyenne, médiane, variance, probabilités, loi binomiale — avec exercices', source: 'SmartSchool SN' },
  { id: 'nat-pc-tle-s1-mecanique', titre: 'Cours — Mécanique de Newton', type: 'resume', matiere: 'Sciences Physiques', niveau: 'Terminale', serie: 'S1', description: 'Cours complet natif : 3 lois de Newton, chute libre, projectiles, énergie — avec exercices corrigés', source: 'SmartSchool SN' },
  { id: 'nat-pc-tle-s1-ondes', titre: 'Cours — Ondes Mécaniques et Lumineuses', type: 'resume', matiere: 'Sciences Physiques', niveau: 'Terminale', serie: 'S1', description: 'Cours complet natif : ondes, son, acoustique, lumière, diffraction — avec exercices', source: 'SmartSchool SN' },
  { id: 'nat-svt-tle-s1-genetique', titre: 'Cours — Génétique et Hérédité', type: 'resume', matiere: 'SVT', niveau: 'Terminale', serie: 'S1', description: 'Cours complet natif : ADN, gènes, allèles, lois de Mendel, hérédité liée au sexe — avec exercices type BAC', source: 'SmartSchool SN' },
  { id: 'nat-philo-tle-l-liberte', titre: 'Cours — La Liberté', type: 'resume', matiere: 'Philosophie', niveau: 'Terminale', serie: 'L', description: 'Cours complet natif : définitions, Spinoza, Sartre, Kant, Rousseau — avec plan de dissertation', source: 'SmartSchool SN' },
  { id: 'nat-fr-tle-dissertation', titre: 'Cours — Méthodologie de la Dissertation', type: 'resume', matiere: 'Français', niveau: 'Terminale', description: 'Cours complet natif : analyser le sujet, construire le plan, rédiger intro/conclusion, connecteurs', source: 'SmartSchool SN' },
  { id: 'nat-hg-tle-l-decolonisation', titre: 'Cours — La Décolonisation en Afrique', type: 'resume', matiere: 'Histoire-Géographie', niveau: 'Terminale', serie: 'L', description: 'Cours complet natif : contexte, indépendance du Sénégal, Senghor, voies de décolonisation', source: 'SmartSchool SN' },
  { id: 'nat-maths-3eme-thales', titre: 'Cours — Théorème de Thalès', type: 'resume', matiere: 'Mathématiques', niveau: '3ème', description: 'Cours complet natif : énoncé, réciproque, applications et exercices type BFEM', source: 'SmartSchool SN' },
  { id: 'nat-maths-3eme-pythagore', titre: 'Cours — Théorème de Pythagore', type: 'resume', matiere: 'Mathématiques', niveau: '3ème', description: 'Cours complet natif : énoncé, calculs de longueurs, réciproque — exercices BFEM', source: 'SmartSchool SN' },
  { id: 'nat-maths-6eme-fractions', titre: 'Cours — Les Fractions', type: 'resume', matiere: 'Mathématiques', niveau: '6ème', description: 'Cours complet natif : définition, simplification, comparaison, addition — exercices', source: 'SmartSchool SN' },
  { id: 'nat-pc-3eme-electricite', titre: 'Cours — Électricité', type: 'resume', matiere: 'Sciences Physiques', niveau: '3ème', description: 'Cours complet natif : tension, intensité, loi d\'Ohm, circuits série/dérivation, puissance', source: 'SmartSchool SN' },
  { id: 'nat-svt-3eme-reproduction', titre: 'Cours — La Reproduction Humaine', type: 'resume', matiere: 'SVT', niveau: '3ème', description: 'Cours complet natif : appareils reproducteurs, cycle menstruel, fécondation, contraception', source: 'SmartSchool SN' },
  { id: 'nat-maths-2nde-fonctions', titre: 'Cours — Les Fonctions', type: 'resume', matiere: 'Mathématiques', niveau: 'Seconde', description: 'Cours complet natif : notion de fonction, courbe, variations, fonctions de référence', source: 'SmartSchool SN' },
  { id: 'nat-exo-maths-tle-s1', titre: 'Exercices Corrigés — Maths Terminale S1', type: 'exercice', matiere: 'Mathématiques', niveau: 'Terminale', serie: 'S1', description: 'Banque d\'exercices corrigés : suites, limites, intégrales, complexes — préparation BAC', source: 'SmartSchool SN' },
  { id: 'nat-exo-maths-3eme', titre: 'Exercices Corrigés — Maths 3ème BFEM', type: 'exercice', matiere: 'Mathématiques', niveau: '3ème', description: 'Banque d\'exercices corrigés : Pythagore, Thalès, fonctions, équations — préparation BFEM', source: 'SmartSchool SN' },
]
